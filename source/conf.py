...
project = 'NeuroScheme'
copyright = '2022, URJC Universidad Rey Juan Carlos'
...
htmlhelp_basename = 'NeuroSchemedoc'
...
latex_documents = [
    (master_doc, 'NeuroScheme.tex', 'NeuroScheme Documentation',
...
man_pages = [
    (master_doc, 'neuroscheme', 'NeuroScheme Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'NeuroScheme', 'NeuroScheme Documentation',
     author, 'NeuroScheme', 'One line description of project.',
     'Miscellaneous'),
]
