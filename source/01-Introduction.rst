...
This documentation is for NeuroScheme version 0.7.3 that can be obtained from the homepage.
...
.. code-block:: bash
  ...
  :emphasize-lines: 11,13
   ...
   xhost +local:docker
   # Pull the image
   docker pull vglab/neuroscheme:0.7.3-nvidia-ubuntu-16.04
   ...
   cd ..
   # Run cortex example
   docker run --gpus 1 -ti --rm -e DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix -v /etc/machine-id:/etc/machine-id -v $(pwd)/neuroscheme-example-data:/data  --privileged vglab/neuroscheme:0.7.3-nvidia-ubuntu-16.04 /usr/bin/NeuroScheme -d cortex -xml /data/neuroscheme-cortex-example-data.xml
   # Run congen example
   docker run --gpus 1 -ti --rm -e DISPLAY -v /tmp/.X11-unix:/tmp/.X11-unix -v /etc/machine-id:/etc/machine-id -v $(pwd)/neuroscheme-example-data:/data  --privileged vglab/neuroscheme:0.7.3-nvidia-ubuntu-16.04 /usr/bin/NeuroScheme -d congen --json /data/neuroscheme-congen-example-data.json
